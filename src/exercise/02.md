...
React is a library for building user interfaces. It is a declarative, efficient, and flexible JavaScript library for building UI. 

Declarative: React is declarative. It means that you describe what you want to see in your UI, and React will render it for you. It abstacts away the imperative DOM API.
